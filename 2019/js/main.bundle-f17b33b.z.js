!function(n) {
    ...
    t.default = function(e, t) {
        return void 0 === t && (t = window.document), o.arrayFrom(t.constructor.prototype.querySelectorAll.call(t, e))
    }
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    t.closest = function e(t, n) {
        return Element.prototype.closest ? Element.prototype.closest.call(t, n) : (o = t, r = n, (Element.prototype.matches || Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector).call(o, r) ? t : t.parentElement ? e(t.parentElement, n) : null);
        var o,
            r
    },
    ...
    t.reportValidity = function(e) {
        ...
        return t.type = "submit", e.appendChild(t), t.click(), e.removeChild(t), !1
    },
    ...
    t.getQueryParams = function(e) {
        var t = r.parse(e);
        return delete t.attempt, delete t.page_uuid, delete t.sub_page, delete t.token, delete t.time, delete t.closedAt, t
    },
    ...
    t.default = function() {
        var e;
        d() && (window.addEventListener("message", c), window.ub.page.usedAs === s.UsedAs.MainPage && l(i.ReportPageSize, {
            ...
            return r.addEventListener("click", function(e) {
                var t = r.href,
                    n = r.target,
                    o = "_top" === n || "_parent" === n;
                t && "#" !== t && (o && e.preventDefault(), l(i.LinkClick, {
    ...
    t.stringify = function(e, t) {
        ...
        for (o in "string" != typeof t && (t = "?"), e)
            if (i.call(e, o)) {
                if ((n = e[o]) || null != n && !isNaN(n) || (n = ""), o = encodeURIComponent(o), n = encodeURIComponent(n), null === o || null === n)
                    continue;
                r.push(o + "=" + n)
            }
    ...
    (function(i) {
        ...
        function y(e, t, n) {
            ...
            var o,
                ...
                f = this,
                d = 0;
            for ("object" !== c && "string" !== c && (n = t, t = null), n && "function" != typeof n && (n = h.parse), t = v(t), o = !(r = g(e || "")).protocol && !r.slashes, f.slashes = r.slashes || o && t.slashes, f.protocol = r.protocol || t.protocol || "", e = r.rest, r.slashes || (l[3] = [/(.*)/, "pathname"]); d < l.length; d++)
                "function" != typeof (a = l[d]) ? (i = a[0], u = a[1], i != i ? f[u] = e : "string" == typeof i ? ~(s = e.indexOf(i)) && (e = "number" == typeof a[2] ? (f[u] = e.slice(0, s), e.slice(s + a[2])) : (f[u] = e.slice(s), e.slice(0, s))) : (s = i.exec(e)) && (f[u] = s[1], e = e.slice(0, s.index)), f[u] = f[u] || o && a[3] && t[u] || "", a[4] && (f[u] = f[u].toLowerCase())) : e = a(e);
            n && (f.query = n(f.query)),
            ...
            f.auth && (a = f.auth.split(":"), f.username = a[0] || "", f.password = a[1] || ""),
        ...
        y.prototype = {
            set: function(e, t, n) {
                ...
                case "port":
                    o[e] = t,
                    p(t, o.protocol) ? t && (o.host = o.hostname + ":" + t) : (o.host = o.hostname, o[e] = "");
                    break;
                case "hostname":
                    o[e] = t,
                    o.port && (t += ":" + o.port),
                ...
                case "host":
                    o[e] = t,
                    /:\d+$/.test(t) ? (t = t.split(":"), o.port = t.pop(), o.hostname = t.join(":")) : (o.hostname = t, o.port = "");
                    break;
                case "protocol":
            ...
            function t(t) {
                return function(e) {
                    return function(t) {
                        ...
                        for (; s;)
                            try {
                                if (r = 1, i && (a = 2 & t[0] ? i.return : t[0] ? i.throw || ((a = i.return) && a.call(i), 0) : i.next) && !(a = a.call(i, t[1])).done)
                                    return a;
                        ...
                        return a(t, void 0, void 0, function() {
                            ...
                            return p(this, function(e) {
                                ...
                                case 4:
                                    return [3, 6];
                                case 5:
                                    return t = e.sent(), m.warn("[Form]", "Submit hook threw error", t), [3, 6];
                                case 6:
                                    return [2]
                                }
                            })
    ...
    function r(c, f) {
        return void 0 === f && (f = window), a(this, void 0, void 0, function() {
            var o,
                r,
                i,
                a,
            ...
            return p(this, function(e) {
                switch (e.label) {
                case 0:
                    return o = HTMLFormElement.prototype.getAttribute.call(c, "action") || "", (r = x.default(c)).disabled = !0, m.log("[Form]", "Calling beforeFormSubmit hooks"), [4, E(f.ub.hooks.beforeFormSubmit, c, f)];
                case 1:
                    if (e.sent(), n = c, function(e) {
                        try {
                    ...
                    }).join("&").replace(/%20/g, "+")), h.pageIsEmbeddable() && h.reportFormSubmit(window.ub.form.isConversionGoal, window.ub.form.action), a = {}, !o)
                        return [3, 7];
                    ...
                    e.label = 2;
                case 2:
                    return e.trys.push([2, 5, , 6]), [4, f.fetch(s, {
                        method: "POST",
                        headers: d({}, _, {
                ...
                case 4:
                    return a = e.sent(), [3, 6];
                case 5:
                    return l = e.sent(), r.disabled = !1, m.error("[Form]", "Request failed", l), f.alert("We're sorry, the form could not be submitted. Please try again."), [2];
                case 6:
                ...
                case 7:
                    ...
                    e.label = 8;
                case 8:
                    return m.log("[Form]", "Calling afterFormSubmit hooks"), [4, E(f.ub.hooks.afterFormSubmit, c, f)];
                case 9:
                    return e.sent(), w.performFormAction(c, a, f), t = c, b.default("input,textarea,select", t).forEach(function(e) {
                        return e.blur()
                    }), r.disabled = !1, g.resetForm(c), [2]
                }
                var t,
                    n
            })
    ...
    function o(e, t) {
        ...
        for (t && null != t.children && (l.length || l.push(t.children), delete t.children); l.length;)
            if ((o = l.pop()) && void 0 !== o.pop)
                ...
                n = r;
        var s = new u;
        return s.nodeName = e, s.children = a, s.attributes = null == t ? void 0 : t, s.key = null == t ? void 0 : t.key, void 0 !== C.vnode && C.vnode(s), s
    }
    function T(e, t) {
        for (var n in t)
            e[n] = t[n];
    ...
    function L(e, t, n, o, r, i) {
        O++ || (v = null != r && void 0 !== r.ownerSVGElement, g = null != e && !("__preactattr_" in e));
        var a = F(e, t, n, o, i);
        return r && a.parentNode !== r && r.appendChild(a), --O || (g = !1, i || M()), a
    }
    function F(e, t, n, o, r) {
        var i = e,
            a = v;
        if (null != t && "boolean" != typeof t || (t = ""), "string" == typeof t || "number" == typeof t)
            return e && void 0 !== e.splitText && e.parentNode && (!e._component || r) ? e.nodeValue != t && (e.nodeValue = t) : (i = document.createTextNode(t), e && (e.parentNode && e.parentNode.replaceChild(i, e), I(e, !0))), i.__preactattr_ = !0, i;
        var s,
            u,
            l = t.nodeName;
        if ("function" == typeof l)
            return function(e, t, n, o) {
                ...
                r && u && (!o || r._component) ? (B(r, l, 3, n, o), e = r.base) : (i && !s && (H(i), e = a = null), r = N(t.nodeName, l, n), e && !r.nextBase && (r.nextBase = e, a = null), B(r, l, 1, n, o), e = r.base, a && e !== a && (a._component = null, I(a, !1)));
                return e
            }(e, t, n, o);
        if (v = "svg" === l || "foreignObject" !== l && v, l = String(l), (!e || !k(e, l)) && (s = l, (u = v ? document.createElementNS("http://www.w3.org/2000/svg", s) : document.createElement(s)).normalizedNodeName = s, i = u, e)) {
            for (; e.firstChild;)
        ...
        return !g && d && 1 === d.length && "string" == typeof d[0] && null != c && void 0 !== c.splitText && null == c.nextSibling ? c.nodeValue != d[0] && (c.nodeValue = d[0]) : (d && d.length || null != c) && function(e, t, n, o, r) {
            ...
            if (0 !== m)
                for (var y = 0; y < m; y++) {
                    ...
                    null != x ? (p++, d[x] = b) : (w || (void 0 !== b.splitText ? !r || b.nodeValue.trim() : r)) && (f[v++] = b)
                }
            if (0 !== g)
                for (var y = 0; y < g; y++) {
                    u = t[y],
                    ...
                    if (null != x)
                        ...
                        for (i = h; i < v; i++)
                            if (void 0 !== f[i] && (_ = a = f[i], A = r, "string" == typeof (E = u) || "number" == typeof E ? void 0 !== _.splitText : "string" == typeof E.nodeName ? !_._componentConstructor && k(_, E.nodeName) : A || _._componentConstructor === E.nodeName)) {
                                l = a,
                                f[i] = void 0,
                                i === v - 1 && v--,
                                i === h && h++;
            ...
            for (; h <= v;)
                void 0 !== (l = f[v--]) && I(l, !1)
        }(i, d, n, o, g || null != f.dangerouslySetInnerHTML), function(e, t, n) {
            var o;
            for (o in n)
        ...
        }(i, t.attributes, f), v = a, i
    }
    function I(e, t) {
        var n = e._component;
        n ? H(n) : (null != e.__preactattr_ && f(e.__preactattr_.ref, null), !1 !== t && null != e.__preactattr_ || j(e), y(e))
    }
    function y(e) {
        for (e = e.lastChild; e;) {
    ...
    function N(e, t, n) {
        var o,
            r = b.length;
        for (e.prototype && e.prototype.render ? (o = new e(t, n), x.call(o, t, n)) : ((o = new x(t, n)).constructor = e, o.render = w); r--;)
    ...
    function B(e, t, n, o, r) {
        e._disable || (e._disable = !0, e.__ref = t.ref, e.__key = t.key, delete t.ref, delete t.key, void 0 === e.constructor.getDerivedStateFromProps && (!e.base || r ? e.componentWillMount && e.componentWillMount() : e.componentWillReceiveProps && e.componentWillReceiveProps(t, o)), o && o !== e.context && (e.prevContext || (e.prevContext = e.context), e.context = o), e.prevProps || (e.prevProps = e.props), e.props = t, e._disable = !1, 0 !== n && (1 !== n && !1 === C.syncComponentUpdates && e.base ? s(e) : U(e, 1, r)), f(e.__ref, e))
    }
    function U(e, t, n, o) {
        if (!e._disable) {
            var r,
                ...
                g = !1,
                y = d;
            if (e.constructor.getDerivedStateFromProps && (u = T(T({}, u), e.constructor.getDerivedStateFromProps(s, u)), e.state = u), p && (e.props = c, e.state = f, e.context = d, 2 !== t && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(s, u, l) ? g = !0 : e.componentWillUpdate && e.componentWillUpdate(s, u, l), e.props = s, e.state = u, e.context = l), e.prevProps = e.prevState = e.prevContext = e.nextBase = null, e._dirty = !1, !g) {
                r = e.render(s, u, l),
                ...
                if ("function" == typeof x) {
                    var _ = S(r);
                    (i = v) && i.constructor === x && _.key == i.__key ? B(i, _, 1, l, !1) : (b = i, e._component = i = N(x, _, l), i.nextBase = i.nextBase || h, i._parentComponent = e, B(i, _, 0, l, !1), U(i, 1, n, !0)),
                    w = i.base
                } else
                    a = m,
                    (b = v) && (a = e._component = null),
                    (m || 1 === t) && (a && (a._component = null), w = L(a, r, l, n || !p, m && m.parentNode, !0));
                if (m && w !== m && i !== v) {
                    var E = m.parentNode;
                    E && w !== E && (E.replaceChild(w, m), b || (m._component = null, I(m, !1)))
                }
                if (b && H(b), (e.base = w) && !o) {
            ...
            for (!p || n ? P.push(e) : g || (e.componentDidUpdate && e.componentDidUpdate(c, f, y), C.afterUpdate && C.afterUpdate(e)); e._renderCallbacks.length;)
    ...
    function H(e) {
        ...
        e.base = null;
        var n = e._component;
        n ? H(n) : t && (null != t.__preactattr_ && f(t.__preactattr_.ref, null), j(e.nextBase = t), b.push(e), y(t)),
        f(e.__ref, null)
    }
    function x(e, t) {
        this._dirty = !0,
    ...
    var u,
        ...
        }, l = ["h1", "h2", "h3", "h4", "span", ".lp-pom-text", /^\#lp\-pom\-text\-/], c = function(e) {
            return l.some(e.match.bind(e))
        }, f = ["font-family", "font-size", "font-weight", "font-height", "letter-spacing"], d = function(e) {
    ...
    var m = {
        ...
        _applySubPixelLetterSpacingFix: function(e, t, n, o) {
            ...
            for (o = o || -2; e.offsetHeight - n > t && o < i;)
                if (i -= .05, e.style.letterSpacing = i + "px", -.85 <= i && e.offsetHeight === r)
        ...
        _applyWidthIncreaseFix: function(e, t, n, o) {
            ...
            return u < 1 && (e.style.transform = l, e.style.webkitTransform = l, e.style.transformOrigin = "top left", e.style.webkitTransformOrigin = "top left"), i
        },
            ...
            try {
                ...
                if (e && ("object" == typeof e || "function" == typeof e)) {
                    ...
                    if ("function" == typeof n)
                        return void f((o = n, r = e, function() {
                            o.apply(r, arguments)
                        }), t)
                }
                t._state = 1,
    ...
    self.fetch || (self.fetch = function(u, l) {
        return l = l || {}, new Promise(function(e, t) {
            ...
            for (var s in n.open(l.method || "get", u, !0), n.onload = function() {
                ...
                e(a())
            }, n.onerror = t, n.withCredentials = "include" == l.credentials, l.headers)
    ...
    t.performFormAction = function(e, t, n) {
        ...
        var o,
            r,
            i = n.ub.form;
        switch (d.log("[Form]", "Performing form action:", i.action), i.action) {
        ...
        case h.FormAction.FormConfirmation:
            !function(e, t) {
                var n = y(e);
                try {
                    t.setItem("ubFormData", JSON.stringify(n))
                } catch (e) {
                    d.warn("[Form - storeFormData]", e)
                }
            }(e, n.sessionStorage),
            function(t, n) {
                if (t.protected_assets)
                    try {
                        Object.keys(t.protected_assets).forEach(function(e) {
                            t.protected_assets && n.setItem("ub-asset-" + e, t.protected_assets[e])
                        })
                    } catch (e) {
            ...
            var a = (o = i.url, r = n.location.href, c(o, r).toString()),
                ...
                u = m.default(n);
            return void (f.pageIsEmbeddable() ? f.showFormConfirmation(s, i.lightboxSize) : u && u.ub.lightbox.openLightbox(s, i.lightboxSize));
        case h.FormAction.ExternalLightbox:
            return a = i.includeFormData ? b(i.url, e) : i.url, void ((u = m.default(n)) && u.ub.lightbox.openLightbox(a, i.lightboxSize));
        case h.FormAction.GoToUrl:
            return !i.url && f.pageIsEmbeddable() ? void f.close() : (a = i.includeFormData ? b(i.url, e) : i.url, void ((u = "_parent" === i.target || n.ub.page.usedAs === p.UsedAs.LightboxPage ? n.parent : n).location.href = a));
        case h.FormAction.PostToUrl:
            if (!i.url && f.pageIsEmbeddable())
                return void f.close();
            var l = HTMLFormElement.prototype.getAttribute.call(e, "action") || "";
            return e.method = "POST", e.action = i.includeFormData ? b(i.url, e) : i.url, e.target = i.target, g.default('input[name^="ubafs-"]', e).forEach(function(e) {
                return e.parentNode && e.parentNode.removeChild(e)
            }), HTMLFormElement.prototype.submit.call(e), void setTimeout(function() {
                e.action = l
            })
        }
    }
        ...
        if (t.match(r)) {
            !function e(t, n, o) {
                ...
                var r = n.shift(),
                    i = r.match(/^\[(.+?)\]$/);
                if ("[]" === r)
                    return t = t || [], Array.isArray(t) ? t.push(e(null, n, o)) : (t._values = t._values || [], t._values.push(e(null, n, o))), t;
                if (i) {
                    var a = i[1],
                        s = +a;
        ...
        for (var n = t.hash ? {} : "", o = t.serializer || (t.hash ? y : b), r = e && e.elements ? e.elements : [], i = Object.create(null), a = 0; a < r.length; ++a) {
            ...
            if ((t.disabled || !s.disabled) && s.name && g.test(s.nodeName) && !v.test(s.type)) {
                ...
                if ("checkbox" !== s.type && "radio" !== s.type || s.checked || (l = void 0), t.empty) {
                    if ("checkbox" !== s.type || s.checked || (l = ""), "radio" === s.type && (i[s.name] || s.checked ? s.checked && (i[s.name] = !0) : i[s.name] = !1), null == l && "radio" == s.type)
                        continue
                } else if (!l)
                    continue;
                if ("select-multiple" !== s.type)
                    ...
                    for (var c = s.options, f = !1, d = 0; d < c.length; ++d) {
                        var p = c[d],
                            h = t.empty && !p.value,
                            m = p.value || h;
                        p.selected && m && (f = !0, n = t.hash && "[]" !== u.slice(u.length - 2) ? o(n, u + "[]", p.value) : o(n, u, p.value))
                    }
                    !f && t.empty && (n = o(n, u, ""))
                }
            }
    ...
    t.default = function(n) {
        void 0 === n && (n = window);
        var e = n.ga;
        n.ub.googleAnalyticsTrackingId && "function" == typeof e && (o.log("[Google Analytics]", "Sending pageview"), n.ub.page.variantId && n.ub.page.usedAs === r.UsedAs.MainPage ? e("send", {
            hitType: "pageview",
    ...
    t.handleFormSubmit = function(o, r) {
        return a(this, void 0, void 0, function() {
            ...
            return s(this, function(e) {
                switch (e.label) {
                case 0:
                    return t = u.closest(o, ".lp-pom-form"), n = i({
                        category: "Form",
                        action: "Submit",
                        label: t ? "#" + t.id : ""
                    }, t ? l.default(t) : {}), [4, c.default(n.category, n.action, n.label, r)];
                case 1:
                    return e.sent(), [2]
                }
            })
    ...
    t.default = function(u, l) {
        return o(this, void 0, void 0, function() {
            ...
            return f(this, function(e) {
                switch (e.label) {
                case 0:
                    return u.isTrusted ? (o = u.currentTarget, (r = p.closest(o, ".lp-element")) ? (i = o.getAttribute("href") || "", (a = !l.navigator.sendBeacon && "_blank" !== o.target && !i.startsWith("#")) && (d.log("[Google Analytics]", "Preventing default link action"), u.preventDefault(), u.stopPropagation(), u.stopImmediatePropagation()), s = c({}, (n = (t = i).split("/")[2] || "", t.startsWith("#") || !t ? {
                        category: "In-Page",
                        action: t || "none"
                        ...
                        label: r.id ? "#" + r.id : ""
                    }, h.default(r)), [4, m.default(s.category, s.action, s.label, l)]) : [2]) : [2];
                case 1:
                    return e.sent(), a && (d.log("[Google Analytics]", "Performing default link action"), o.click()), [2]
                }
                var t,
                    n
            })
    ...
    t.gtmHandleFormSubmit = function(e) {
        e.ub.googleTagManagerContainerId && Array.isArray(e.dataLayer) && (o.log("[Google Tag Manager]", "Adding data layer event"), e.dataLayer.push({
    ...
    t.default = function() {
        if (o.isIos()) {
            var e = document.querySelector("meta[name=viewport]") || ((t = document.createElement("meta")).setAttribute("name", "viewport"), t.setAttribute("content", "width=device-width, initial-scale=1"), document.head.appendChild(t), t);
    ...
    t.default = function(n) {
        var e,
            o;
        if (void 0 === n && (n = window), e = n, o = f.default(e), (e.ub.page.lightboxTriggers || []).forEach(function(t) {
    ...
    "use strict";
    var o,
        r = this && this.__extends || (o = function(e, t) {
    ...
    var i = n(16),
        ...
        u = function(n) {
            function e(e) {
                ...
                }, t.lightboxElement = null, t.lightboxElementRef = t.lightboxElementRef.bind(t), t.updateOverflows = t.updateOverflows.bind(t), t
            }
            return r(e, n), e.prototype.render = function() {
                var e = this.props,
                    t = e.onClose,
                    n = e.url,
    ...
    function b(t, e) {
        ...
        if (e.singleton) {
            ...
            r = t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (a = e, s = document.createElement("link"), void 0 === a.attrs.type && (a.attrs.type = "text/css"), a.attrs.rel = "stylesheet", y(s, a.attrs), m(a, s), o = function(e, t, n) {
                var o = n.css,
                    r = n.sourceMap,
    ...
    e.exports = function(e) {
        ...
        return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(e, t) {
            ...
            return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(o) ? e : (n = 0 === o.indexOf("//") ? o : 0 === o.indexOf("/") ? r + o : i + o.replace(/^\.\//, ""), "url(" + JSON.stringify(n) + ")")
        })
    }
}, function(e, t, n) {
    "use strict";
    ...
    function s(e, t) {
        var n,
            ...
            r = "lp-pom-root" === (n = e).id ? window.innerWidth / window.innerHeight : n.offsetWidth / n.offsetHeight;
        if (r < o) {
            var i = o / r - 1;
            return {
                top: "0",
    ...
    function(e, m) {
        ...
        function s() {
            ...
            if (e = r, !isNaN(parseFloat(e)) && isFinite(e) && Math.floor(e) == e)
            ...
            if (!e.WeakMap) {
                ...
                e.WeakMap = function() {
                    function e() {
                        ...
                        if (r(this, "_id", "_WeakMap" + "_" + t() + "." + t()), 0 < arguments.length)
        ...
        var l,
            c = (function(e) {
                ...
                o = function() {
                    ...
                    function p(e) {
                        ...
                        this.then = function(e, t) {
                            ...
                            return n.promise = new this.constructor(function(e, t) {
                                ...
                                n.resolve = e,
                                n.reject = t
                            }), o.chain.push(n), 0 !== o.state && i(u, o), n.promise
                        },
                                ...
                                (function e(n) {
                                    ...
                                    if (!r.triggered) {
                                        ...
                                        try {
                                            ...
                                            }) : (r.msg = n, r.state = 1, 0 < r.chain.length && i(u, r))
                                        } catch (e) {
                                            l.call(new f(r), e)
                                        }
                                    }
                    ...
                    return t(p.prototype = h, "__NPO__", 0, !1), t(p, "resolve", function(n) {
        ...
        function h(e, t, n) {
            ...
            if (!o[t])
                return !0;
            if (!n)
                return o[t] = [], f.set(e.element, o), !0;
            var r = o[t].indexOf(n);
            return -1 !== r && o[t].splice(r, 1), f.set(e.element, o), o[t] && 0 === o[t].length
        }
                        ...
                        if (403 !== r.status)
                            try {
                                ...
                                if (403 === e.domain_status_code)
                                    return y(e, s), void n(new Error("“".concat(i, "” is not embeddable.")));
                                t(e)
                            } catch (e) {
                                n(e)
                            }
        ...
        var E = new WeakMap,
            ...
            k = function() {
                function n(i) {
                    ...
                    }(this, n), window.jQuery && i instanceof jQuery && (1 < i.length && window.console && console.warn && console.warn("A jQuery object with multiple elements was passed, using the first element."), i = i[0]), "undefined" != typeof document && "string" == typeof i && (i = document.getElementById(i)), !(i instanceof window.HTMLElement))
                    ...
                    var t = new c(function(r, t) {
                        var e = function(e) {
                            if (u(e.origin) && a.element.contentWindow === e.source) {
                                ...
                                if (n || o)
                                    return a.element.setAttribute("data-ready", "true"), void r();
                                _(a, t)
                            }
                        };
                        if (window.addEventListener ? window.addEventListener("message", e, !1) : window.attachEvent && window.attachEvent("onmessage", e), "IFRAME" !== a.element.nodeName) {
                            ...
                            b(s(n), n, i).then(function(e) {
                                var t,
                                    ...
                                    o,
                                    r = y(e, i);
                                return a.element = r, a._originalElement = i, t = i, n = r, o = f.get(t), f.set(n, o), f.delete(t), E.set(a.element, a), e
                            }).catch(function(e) {
                                return t(e)
                            })
                        }
                    });
                    return A.set(this, t), E.set(this.element, this), "IFRAME" === this.element.nodeName && x(this, "ping"), this
                }
                var e,
                    t,
                    o;
                return e = n, (t = [{
                    ...
                    value: function(n) {
                        var o = this;
                        return new c(function(e, t) {
                            return n = i(n, "get"), o.ready().then(function() {
                                d(o, n, {
                                    resolve: e,
                                    reject: t
                                }),
                    ...
                    value: function() {
                        ...
                        return new c(function(e) {
                            A.delete(t),
                            E.delete(t.element),
                            t._originalElement && (E.delete(t._originalElement), t._originalElement.removeAttribute("data-vimeo-initialized")),
    ...
    function a(a, s) {
        return function(e) {
            ...
            case YT.PlayerState.PLAYING:
                return s.style.opacity = "1", n = a, void (0 < (o = (t = i).getDuration() - t.getCurrentTime() - .2) && (window.clearTimeout(n), n = window.setTimeout(function() {
                    u(t)
                }, 1e3 * o)));
    ...
    var o = n(54);
    t.default = function() {
        window.ub.page.visitorId = function() {
            try {
                return o.parse(document.cookie).ubvs || null
            } catch (e) {
                return null
            }
        }()
    ...
    t.parse = function(e, t) {
        ...
        for (var n = {}, o = t || {}, r = e.split(d), i = o.decode || f, a = 0; a < r.length; a++) {
            var s = r[a],
                u = s.indexOf("=");
            if (!(u < 0)) {
                var l = s.substr(0, u).trim(),
                    c = s.substr(++u, s.length).trim();
                '"' == c[0] && (c = c.slice(1, -1)),
                null == n[l] && (n[l] = p(c, i))
            }
        }
    ...
    !function() {
        ...
        function d(e, t, n, o) {
            ...
            if (r) {
                ...
                return i.onload = i.onreadystatechange = function() {
                    a || this.readyState && "loaded" != this.readyState && "complete" != this.readyState || (a = !0, n && n(null), i.onload = i.onreadystatechange = null, "HEAD" == i.parentNode.tagName && r.removeChild(i))
        ...
        P.prototype.start = function() {
            var r = this.c.o.document,
                ...
                e = new Promise(function(n, o) {
                    !function t() {
                        var e;
                        s() - a >= i.f ? o() : r.fonts.load((e = i.a, _(e) + " " + e.f + "00 300px " + w(e.c)), i.h).then(function(e) {
        ...
        var H = null;
        function R(e) {
            0 == --e.f && e.j && (e.m ? ((e = e.a).g && m(e.f, [e.a.c("wf", "active")], [e.a.c("wf", "loading"), e.a.c("wf", "inactive")]), k(e, "active")) : A(e.a))
        }
        function e(e) {
            this.j = e,
            this.a = new C,
                            ...
                            if (0 === c.length && p)
                                ...
                                for (n = 0; n < c.length; n++) {
                                    var r = c[n],
                                        ...
                                        a = l.a,
                                        s = r;
                                    if (a.g && m(a.f, [a.a.c("wf", s.c, x(s).toString(), "loading")]), k(a, "fontloading", s), (a = null) === H)
                                        if (window.FontFace) {
                        ...
                        if (u["__mti_fntLst" + s]) {
                            ...
                            if (n)
                                for (var r = 0; r < n.length; r++) {
                                    ...
                                    null != n[r].fontStyle && null != n[r].fontWeight ? (t = n[r].fontStyle + n[r].fontWeight, o.push(new b(i, t))) : o.push(new b(i))
                                }
                            a(o)
                        } else
                            setTimeout(function() {
            ...
            !function(e) {
                for (var t = e.f.length, n = 0; n < t; n++) {
                    ...
                    if (2 <= o.length) {
                            ...
                            for (var s, u = (s = s.split(",")).length, l = 0; l < u; l++) {
                                ...
                                if ((c = s[l]).match(/^[\w-]+$/))
                                    if (null == (d = $.exec(c.toLowerCase())))
                                        ...
                                        if (c = null == (c = d[2]) || "" == c ? "n" : Y[c], null == (d = d[1]) || "" == d)
                                            d = "4";
                                        else
                                            var f = G[d],
                        ...
                        0 < a.length && (i = a),
                        3 == o.length && (a = [], 0 < (o = (o = o[2]) ? o.split(",") : a).length && (o = V[o[0]]) && (e.c[r] = o))
                    }
                    for (e.c[r] || (o = V[r]) && (e.c[r] = o), o = 0; o < i.length; o += 1)
        ...
        K.prototype.load = function(l) {
            var e,
                ...
                n = this.c.o,
                c = this;
            t ? (n.__webfontfontdeckmodule__ || (n.__webfontfontdeckmodule__ = {}), n.__webfontfontdeckmodule__[t] = function(e, t) {
                for (var n = 0, o = t.fonts.length; n < o; ++n) {
                    var r = t.fonts[n];
                    c.a.push(new b(r.name, (i = "font-weight:" + r.weight + ";font-style:" + r.style, u = s = a = void 0, a = 4, s = "n", u = null, i && ((u = i.match(/(normal|oblique|italic)/i)) && u[1] && (s = u[1].substr(0, 1).toLowerCase()), (u = i.match(/([1-9]00|normal|bold)/i)) && u[1] && (/bold/i.test(u[1]) ? a = 7 : /[1-9]00/.test(u[1]) && (a = parseInt(u[1].substr(0, 1), 10)))), s + a)))
                }
                var i,
                    a,
                    s,
