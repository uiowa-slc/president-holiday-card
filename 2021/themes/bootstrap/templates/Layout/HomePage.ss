            ...
            <div class="back py-lg-4" id="back">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center border-right-green p-lg-5 pt-3">
                        ...
                        <p class="handwritten-note my-lg-5 my-xl-5">Wishing you warmth and holiday cheer as we reflect on the past, present, and future at Iowa, celebrating 175 years.</p>
                        <p><img loading="lazy" src="{$ThemeDir}/dist/images/signatures5.png" alt="Barbra J. Wilson and John C. Lammers' signatures" class="signatures" /></p>
                        <p class="signature-text">Barbara J. Wilson and John C. Lammers</p>
                    </div>
                    <div class="col-lg-6 text-center px-5 position-relative">
                        <img loading="lazy" src="{$ThemeDir}/dist/images/stamp-area4.png" alt="Decorative graphic of a stamp and the text &quo;Place stamp here&quo;" role="presentation" class="stamp-area d-inline-block d-xl-block w-100" />
