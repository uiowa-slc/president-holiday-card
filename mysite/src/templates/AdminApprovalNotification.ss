        ...
        <center data-parsed="">
            ...
            <table align="center" class="container float-center"><tbody><tr><td>
              ...
              <table class="row"><tbody><tr>
                ...
                <p>Someone submitted a photo to the <a href="$absoluteBaseURL" target="_blank">2017 Holiday Greeting Card Site:</a></p>
                <p style="color: #484848; line-height: 1.5;"></p>
                  ...
                  <table class="button">
                    <tr>
                      <td>
                        <table>
                          <tr>
                            <td><a href="{$CMSLink}" target="_blank">Approve or deny this photo here</a></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
