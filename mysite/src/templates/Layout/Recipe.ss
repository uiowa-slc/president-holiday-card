<article role="main">
  <div class="row column">
        <h1 class="recipe__header recipe__header--print">Chef Barry's Sugar Cookie Recipe</h1>
        <ul class="recipe__ingredients recipe__ingredients--print">
    ...
    <div class="row column">
        <h2 class="submissions-carousel__header submissions-carousel__header--print">Share your Iowa cookie creations with us: <br /> greeting.president.uiowa.edu</h2>
        <footer class="footer footer--print row expanded">
          <div class="large-12 columns">
            <img class="footer__logo footer__logo--print" src="mysite/dist/images/uiowa.png" alt="The University of Iowa" />
          </div>
