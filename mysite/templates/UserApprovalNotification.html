...
<head>
  ...
  <title>$SiteConfig.EmailApprovalSubject</title>
  <!-- <style> -->
</head>
<body>
        ...
        <center data-parsed="">
            ...
            <table align="center" class="container float-center"><tbody><tr><td>
              ...
              <table class="row"><tbody><tr>
                ...
                <p class="lead">$SiteConfig.EmailApprovalSubject</p>
                ...
                <center data-parsed="">
                  <table class="button float-center"><tr><td><table><tr><td><a href="{$Link}">View or share this card on the web:</a></td></tr></table></td></tr></table>
                </center>
