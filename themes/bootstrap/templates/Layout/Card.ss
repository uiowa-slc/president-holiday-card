<div class="card-body">
    <div class="container-xl">
        ...
        <div class="row pt-3 justify-content-center">
            ...
            <p class="text-center card-share-link"><i class="fas fa-link"></i> <a href="{$AbsoluteLink}" target="_blank" rel="noopener">{$AbsoluteLink}</a> </p>
